    ...
    <div class="app-container">
        ...
        <el-table
            ...
            <el-table-column  align="left" label="操作" width="210" >
                <template slot-scope="scope">
                    <el-button v-permission="'article:view'" type="primary" @click="openView(scope.row.id)" size="mini">查看</el-button>

                    <!-- 审核：只有status===1 才显示，其他不显示。删除：只有status !==0 才显示，其他不显示-->
                    <el-button v-permission="'article:audit'" v-if="scope.row.status === 1" type="success" 
